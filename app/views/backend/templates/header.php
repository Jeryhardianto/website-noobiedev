                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?= BASEURL ?>/assets/backend/images/logo.png" alt="homepage" class="light-logo" width="20px" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="<?= BASEURL ?>/assets/backend/images/logo.png" alt="homepage" class="light-logo"
                             width="140px" />
                    </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
