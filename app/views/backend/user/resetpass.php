    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title mt-3">Reset Password</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card custom-border-top box-card">
                    <form class="form-horizontal" action="<?= BASEURL ?>/userprofile/_proses_resetpass" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="pass"
                                            class="col-sm-2 text-end control-label col-form-label">Password Baru</label>
                                        <div class="col-sm-10">
